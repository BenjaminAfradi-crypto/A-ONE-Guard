const CACHE='aone-guard-v7';
const CORE=['./index.html','./login.html','./admin-login.html','./register.html','./change-password.html','./change-password.js','./app.html','./admin.html','./styles.css','./core.js','./auth.js','./register.js','./employee.js','./admin.js','./register-sw.js','./manifest.webmanifest','./assets/aone-mark.svg','./assets/aone-logo.svg'];
